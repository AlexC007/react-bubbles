...
In this sprint we utilized "Protected Routes", routes that require a certain key i.e. Username and password in order to recieve a "token" that will allow them to access secured data.
